...
static const struct is_reg pmu_ois_mcu_regs[] = {
	{0x3800, "OIS_CPU_CONFIGURATION"},
	{0x3804, "OIS_CPU_STATUS"},
	{0x3808, "OIS_CPU_STATES"},
	{0x380c, "OIS_CPU_OPTION"},
	{0x3860, "OIS_CPU_OUT"}
};
...
static const struct is_reg ois_mcu_peri_regs[] = {
	...
	{0x0064, "OIS_PERI_FS2"},
	{0x0068, "OIS_PERI_FS3"},
#ifdef CONFIG_MCU_S5E9925_EVT0
	{0x00c0, "OIS_PERI_CON_CTRL"},
	{0x00c8, "OIS_PERI_PUD_CTRL"},
	{0x00e0, "OIS_PER2_CON_CTRL"},
	{0x00e8, "OIS_PERI2_PUD_CTRL"},
#else
	{0x0080, "OIS_PERI_CON_CTRL"},
	{0x0088, "OIS_PERI_PUD_CTRL"},
	{0x00a0, "OIS_PER2_CON_CTRL"},
	{0x00a8, "OIS_PERI2_PUD_CTRL"},
#endif
...
enum is_hw_ois_mcu_cmd_name {
	...
	R_OIS_CMD_VDIS_X1_ANG_1,
	R_OIS_CMD_VDIS_X1_ANG_2,
	R_OIS_CMD_VDIS_Y1_ANG_1,
	R_OIS_CMD_VDIS_Y1_ANG_2,
	R_OIS_CMD_VDIS_X2_ANG_1,
	R_OIS_CMD_VDIS_X2_ANG_2,
	R_OIS_CMD_VDIS_Y2_ANG_1,
	R_OIS_CMD_VDIS_Y2_ANG_2,
	R_OIS_CMD_VDIS_X3_ANG_1,
	R_OIS_CMD_VDIS_X3_ANG_2,
	R_OIS_CMD_VDIS_Y3_ANG_1,
	R_OIS_CMD_VDIS_Y3_ANG_2,
	R_OIS_CMD_VDIS_X4_ANG_1,
	R_OIS_CMD_VDIS_X4_ANG_2,
	R_OIS_CMD_VDIS_Y4_ANG_1,
	R_OIS_CMD_VDIS_Y4_ANG_2
#endif
};
...
#ifdef OIS_ANGLE_SUPPORT
	{OIS_CMD_BASE + 0x57C, "OIS_CMD_VDIS_X1_ANG_1"},
	{OIS_CMD_BASE + 0x57D, "OIS_CMD_VDIS_X1_ANG_2"},
	{OIS_CMD_BASE + 0x57E, "OIS_CMD_VDIS_Y1_ANG_1"},
	{OIS_CMD_BASE + 0x57F, "OIS_CMD_VDIS_Y1_ANG_2"},
	{OIS_CMD_BASE + 0x582, "OIS_CMD_VDIS_X2_ANG_1"},
	{OIS_CMD_BASE + 0x583, "OIS_CMD_VDIS_X2_ANG_2"},
	{OIS_CMD_BASE + 0x584, "OIS_CMD_VDIS_Y2_ANG_1"},
	{OIS_CMD_BASE + 0x585, "OIS_CMD_VDIS_Y2_ANG_2"},
	{OIS_CMD_BASE + 0x588, "OIS_CMD_VDIS_X3_ANG_1"},
	{OIS_CMD_BASE + 0x589, "OIS_CMD_VDIS_X3_ANG_2"},
	{OIS_CMD_BASE + 0x58A, "OIS_CMD_VDIS_Y3_ANG_1"},
	{OIS_CMD_BASE + 0x58B, "OIS_CMD_VDIS_Y3_ANG_2"},
	{OIS_CMD_BASE + 0x58E, "OIS_CMD_VDIS_X4_ANG_1"},
	{OIS_CMD_BASE + 0x58F, "OIS_CMD_VDIS_X4_ANG_2"},
	{OIS_CMD_BASE + 0x590, "OIS_CMD_VDIS_Y4_ANG_1"},
	{OIS_CMD_BASE + 0x591, "OIS_CMD_VDIS_Y4_ANG_2"}
#endif
};
